...
*/
	...
	public void initialize() throws IOException
	{
		...
		{
			// 打开监听信道并设置为非阻塞模式
			sc = SocketChannel.open(new InetSocketAddress(hostIp,
					hostListenningPort));
    ...
    public void initialize_test() {
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    // 打开监听信道并设置为非阻塞模式
                    sc = SocketChannel.open(new InetSocketAddress(SOCKET_SERVER,
                            SOCKET_PORT));
